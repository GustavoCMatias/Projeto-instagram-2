...
const nome_usuario = 'Catana'
const foto_usuario = "assets/img/catanacomics.svg"
...
export default function Corpo() {
    ...
    return (
        <div class="corpo">
            <div class="esquerda">
                <div class="stories">
                    {list_stories.map(s => <Storie key={s.name} imagem={s.img} usuario={s.name} />)}
                ...
                <div class="posts">
                    {list_posts.map(p => <Post key= {p.foto_autor} foto_autor={p.foto_autor} autor={p.autor} post={p.post} foto_curtida={p.foto_curtida} autor_curtida={p.autor_curtida} numero={p.numero} />)}

                </div>
            </div>
            <div class="sidebar">
                <Usuario nome_usuario={nome_usuario} foto_usuario={foto_usuario}/>
                ...
                <div class="sugestoes">
                    ...
                    {list_sugestoes.map(s => <Sugestao key={s.nome} foto={s.foto} nome={s.nome} texto={s.texto} />)}
                </div>
